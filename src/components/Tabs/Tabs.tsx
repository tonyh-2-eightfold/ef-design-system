...
function TabsTrigger({
  ...
  return (
    ...
    >
      ...
      {children}
      {badge != null && (
        <span className="ml-1.5 h-6 min-w-6 rounded-xl bg-muted px-1.5 text-center text-xs font-medium tabular-nums text-muted-foreground inline-flex items-center justify-center">
          {badge > 99 ? '99+' : badge}
        </span>
      )}
    </TabsPrimitive.Trigger>
